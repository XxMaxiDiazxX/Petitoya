...
export const Registro = () => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        contrasena: Yup
            ...
            .matches(
                /^(?=.*\d)(?=.*[A-Z])(?=.*[\W_]).*$/,
                'La contraseña debe contener al menos un número, una letra mayúscula y un caracter especial'
            )
    ...
    const onSubmit = async (values, { setSubmitting }) => {
        try {
            ...
            setSubmitting(false); // Asegurar que setSubmitting se maneje adecuadamente
        }
    };
    ...
    const handleSuccessfulRegistration = (userData) => {
        ...
        navigate('/'); // Solo redirigir después de un registro exitoso
    };
