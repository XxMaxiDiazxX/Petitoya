      ...
      <div className="container">
        <nav className="row justify-content-between">
          ...
          <ul className='col-12 col-md-3 list-unstyled'>
            <li className='text-center text-uppercase font-weight-bold'>Redes Sociales</li>
            <li className='text-center'><Link to="/" className='text-reset'>Nombre_intragram</Link></li>
            <li className='text-center'><Link to="/" className='text-reset'>Nombre_intragram</Link></li>
          </ul>

          <ul className='col-12 col-md-3 list-unstyled'>
            <li className='text-center text-uppercase font-weight-bold'>Contacto</li>
          ...
          <ul className='col-12 col-md-3 list-unstyled'>
            <li className='text-center text-uppercase font-weight-bold'>Nosotros</li>
